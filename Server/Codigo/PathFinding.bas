...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Function Limites de PathFinding.bas")
End Function
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Function IsWalkable de PathFinding.bas")
End Function
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Sub ProcessAdjacents de PathFinding.bas")
End Sub
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Sub SeekPath de PathFinding.bas")
End Sub
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Sub MakePath de PathFinding.bas")
End Sub
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Sub InitializeTable de PathFinding.bas")
End Sub
