...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Function hexMd52Asc de modHexaStrings.bas")
End Function
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Function hexHex2Dec de modHexaStrings.bas")
End Function
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Function txtOffset de modHexaStrings.bas")
End Function
