...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Sub Drop_Click de frmDuelo3v3.frm")
End Sub
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Sub Resu_Click de frmDuelo3v3.frm")
End Sub
...
On Error GoTo ErrHandler
    ...
    Call ActivarBotones
    Me.Picture = LoadPicture(DirInterfaces & SELECTED_UI & "VentanaDuelo3v3.jpg")
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Sub Form_Load de frmDuelo3v3.frm")
End Sub
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Sub ActivarBotones de frmDuelo3v3.frm")
End Sub
...
On Error GoTo ErrHandler
    ...
    If Not Len(Nick1.text) >= 1 Or Not Len(Nick2.text) >= 1 Or Not Len(Nick3.text) >= 1 Or Not Len(Nick4.text) >= 1 Or Not Len(Nick5.text) >= 1 Then Exit Sub
    Call WriteRetar(3, Val(Oro.text), Dropi, Nick1.text, Nick2.text, Nick3.text, Resui, Nick4.text, Nick5.text)
    Me.Visible = False
  
  Exit Sub
  
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Sub imgRetar_Click de frmDuelo3v3.frm")
End Sub
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Sub CloseWindow de frmDuelo3v3.frm")
End Sub
