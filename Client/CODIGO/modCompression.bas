...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Function General_Drive_Get_Free_Bytes de modCompression.bas")
End Function
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Sub Sort_Info_Headers de modCompression.bas")
End Sub
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Function BinarySearch de modCompression.bas")
End Function
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Sub Compress_Data de modCompression.bas")
End Sub
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Sub Decompress_Data de modCompression.bas")
End Sub
...
'*****************************************************************
    ...
    Dim SourceFileNamePng As String
...
#End If
    ...
    ' Get the PNG Files
    SourceFileNamePng = Dir$(SourcePath & "*" & ".png", vbNormal)
    While SourceFileNamePng <> ""
        FileHead.lngNumFiles = FileHead.lngNumFiles + 1
        
        ReDim Preserve InfoHead(FileHead.lngNumFiles - 1)
        InfoHead(FileHead.lngNumFiles - 1).strFileName = UCase$(SourceFileNamePng)
...
ErrHandler:
  Close ResourceFile
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Function Get_File_RawData de modCompression.bas")
End Function
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Function Get_File_Data de modCompression.bas")
End Function
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Function Compare_Datas de modCompression.bas")
End Function
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Function ReadNext_InfoHead de modCompression.bas")
End Function
...
On Error GoTo ErrHandler
    ...
    While (ReadNext_InfoHead(ResourceFile, FileHead, InfoHead, ReadFiles)) And Not GetNext_Bitmap
        #If EnableSecurity Then
            Call Secure_Info_Header(InfoHead)
        #End If
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Function GetNext_Bitmap de modCompression.bas")
End Function
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Function AlignScan de modCompression.bas")
End Function
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Function GetVersion de modCompression.bas")
End Function
