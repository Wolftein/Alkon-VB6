...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Function CreateNamedMutex de PrevInstance.bas")
End Function
...
On Error GoTo ErrHandler
    ...
    If CreateNamedMutex("AlkonOnlineClientMutex") Then
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Function FindPreviousInstance de PrevInstance.bas")
End Function
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Sub ReleaseInstance de PrevInstance.bas")
End Sub
