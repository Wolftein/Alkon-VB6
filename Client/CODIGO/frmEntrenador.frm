...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Sub Form_Load de frmEntrenador.frm")
End Sub
...
On Error GoTo ErrHandler
    ...
    Me.Picture = LoadPicture(GrhPath & "VentanaEntrenador.jpg")
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Sub LoadControls de frmEntrenador.frm")
End Sub
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Sub imgLuchar_Click de frmEntrenador.frm")
End Sub
...
ErrHandler:
  Call LogError("Error" & Err.Number & "(" & Err.Description & ") en Sub CerrarVentana de frmEntrenador.frm")
End Sub
